 ...
 */
const SERVERS = {
  "GET /api/[...slug]": (params: { slug: (string | number)[] }) => {
    return `/api/${params['slug']?.join('/')}`
  },
  "PUT /api/[...slug]": (params: { slug: (string | number)[] }) => {
    return `/api/${params['slug']?.join('/')}`
  },
  "DELETE /api/[...slug]": (params: { slug: (string | number)[] }) => {
    return `/api/${params['slug']?.join('/')}`
  },
  "POST /api/[...slug]": (params: { slug: (string | number)[] }) => {
    return `/api/${params['slug']?.join('/')}`
  },
  "PATCH /api/[...slug]": (params: { slug: (string | number)[] }) => {
    return `/api/${params['slug']?.join('/')}`
  },
  "fallback /api/[...slug]": (params: { slug: (string | number)[] }) => {
    return `/api/${params['slug']?.join('/')}`
  }
}
